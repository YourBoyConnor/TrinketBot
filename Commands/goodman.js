...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('goodman')
    .setDescription('BWAOWAOOOOOOO BOOODOLODLOLOLODOOOOOOOOOOOOOO DO DO DO DOOOOUOUO'),
  async execute (client, interaction) {
    ...
    const resource = createAudioResource(join(__dirname, 'Audio/goodman.mp3'));
    ...
    return interaction.reply('**Saul Goodman**')
  },
};
